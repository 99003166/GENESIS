...
/* Covid operations */
enum operations{ VISITS=1, POSITIVE=1, NEGATIVE, DIED=1, RECOVERED, HOMEQUARANT=1, REVISIEDPOS=1, REVISITEDNEG, HOSPQUARANT=1, COMPISOLATION=1, DIFFSTATEPOS=1, DIFFSTATENEG, PRIMECON=1, SECCON=1, INFECTEDRATE, DEATHRATE, RECOVERYRATE, EXIT };
